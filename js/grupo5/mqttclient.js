...
client.onMessageArrived = function (message) {
    try {
        ...
        if (response.mac_address === '39:72:e4:c9:92:25') {
		...
		if (Array.isArray(response) && response.length === 10) {
            ...
            var mismaMacAddress = response.every(function(registro) {
                return registro.mac_address === '39:72:e4:c9:92:25';
            });
        ...
        if (Array.isArray(response) && response.length === 10) {
            ...
            var macAddressDiferente = response.every(function(registro) {
                var macAddressesProhibidas = ['39:72:e4:c9:92:25', '10:20:40:80:01:02', '00:00:01:03:06:0c'];
